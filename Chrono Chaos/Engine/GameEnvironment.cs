...
public class GameEnvironment : Game
{
    ...
    protected override void Update(GameTime gameTime)
    {
        ...
        //camera volgt speler
        if (gameStateManager.CurrentGameState is GameState gamestate)
        {
            camera.Follow(
                new Rectangle((int)gamestate.PlayerPosition.X, (int)gamestate.PlayerPosition.Y, gamestate.Player.Width, gamestate.Player.Height),
                new Vector2(GameEnvironment.Screen.X, GameEnvironment.Screen.Y),
                gamestate.WorldSize
            );
        }
    }
    ...
    protected override void Draw(GameTime gameTime)
    {
        ...
        if (gameStateManager.CurrentGameState is GameState gameState)
        {
            spriteBatch.Begin(SpriteSortMode.Deferred, null, null, null, null, null, spriteScale * Matrix.CreateTranslation(camera.position.X, camera.position.Y, 0));
