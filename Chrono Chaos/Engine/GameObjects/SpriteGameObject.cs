	...
	public class SpriteGameObject : GameObject
	{
		...
		public bool CollidesWith(SpriteGameObject obj)
		{
			...
			for (int x = 0; x < b.Width; x++)
			{
				...
				{
					int thisx = (int)((b.X - (GlobalPosition.X - origin.X) + x) / scale);
					int thisy = (int)((b.Y - (GlobalPosition.Y - origin.Y) + y) / scale);
					int objx = (int)((b.X - (obj.GlobalPosition.X - obj.origin.X) + x) / obj.Scale);
					int objy = (int)((b.Y - (obj.GlobalPosition.Y - obj.origin.Y) + y) / obj.Scale);
