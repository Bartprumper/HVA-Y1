    ...
    public class TextInput : UIElement
    {
        ...
        public override UIElementMouseState UIElementState
        {
            ...
            set
            {
                ...
                if (uiElementMouseState == UIElementMouseState.Disabled)
                {
                    isFocused = false;
                }
            }
        ...
        private void HandleFocusedState(InputHelper inputHelper)
        {
            if (background.BoundingBox.Contains(inputHelper.MousePosition))
            {
                if (!isFocused && inputHelper.MouseLeftButtonReleased)
                {
                    isFocused = true;
                }
            }
        ...
        public override void HandleInput(InputHelper inputHelper)
        {
            ...
            HandleFocusedState(inputHelper);
