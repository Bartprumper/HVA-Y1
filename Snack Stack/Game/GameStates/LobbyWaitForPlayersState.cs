...
namespace Blok3Game.GameStates
{
    public class LobbyWaitForPlayersState : MovableMenuItem
    {
        ...
        {
            Button buttonStart = CreateButton(new Vector2(400, 350), "Begin met spelen", OnButtonStartClicked);
            Button buttonCancel = CreateButton(new Vector2(600, 350), "Annuleren", OnButtonCancelClicked);
        }
        ...
        private void AddPlayer(PlayerData player)
        {
            ...
            TextGameObject textGameObject = CreateText("Fonts/SpriteFont", new Vector2(420, 250 + 50 * players.Count), playerName);
        ...
        {
            if (playerDisconnectedData == null || playerDisconnectedData.Player == null)
            {
                return;
            }
        ...
        {
            if (SocketClient.Instance.RoomId != data.RoomId) // Kijkt of de roomId overeenkomt met de huidige roomId
            {
                return; // Als de roomId niet overeenkomt, dan is dit niet de game die we willen starten
            }
